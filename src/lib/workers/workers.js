    ...
    async fetch(request, env, ctx) {
        ...
        if (!upgradeHeader || upgradeHeader !== 'websocket') {
            ...
            if (cfspiderPath === '' || cfspiderPath === '/') {
                ...
                const vlessLink = 'vless://' + userID + '@' + url.hostname + ':443?security=tls&type=ws&host=' + url.hostname + '&sni=' + url.hostname + '&path=' + encodeURIComponent(vlessPath) + '&encryption=none#CFspider-' + colo;
